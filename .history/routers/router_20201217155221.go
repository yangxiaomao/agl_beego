 ...
 * @LastEditTime: 2020-12-17 15:52:21
...
func init() {
	...
	// 曲线图WebSocket获取数据
	beego.Router("/ws/diagram_data", &clientv1.WebSocketController{}, "get:DiagramData")
	...
	ns := beego.NewNamespace("/api1",
		...
		beego.NSNamespace("/client",
			...
			beego.NSNamespace("/sort",
				//冒泡排序
				beego.NSRouter("/bubble_sort", &clientv1.SortController{}, "*:BubbleSortHandle"),
			),
			//js小游戏组路由
			beego.NSNamespace("/jsgame",
				//3D旋转拼图游戏
				beego.NSRouter("/rotating_jigsaw_3d", &clientv1.GameController{}, "*:RotatingJigsaw"),
			),
		),
		//Admin端路由组
